...
function setup() {
  ...
  ground.x = ground.width /2;
   ...
   gameOver = createSprite(width-500,height-130);
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(width-500,height-90);
...
function draw() {
  ...
  text("gameState: "+gameState,width-200,height-170);
  ...
  if(gameState === PLAY){
    ...
    if(touches.lengths>0||keyDown("space")&& trex.y >= 100) {
        trex.velocityY = -12;
        jumpSound.play();
        touches = [];
    }
